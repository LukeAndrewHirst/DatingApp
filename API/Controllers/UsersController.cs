...
namespace API.Controllers
{
    ...
    public class UsersController : BaseApiController
    {
        ...
        {
            var user = await _unitOfWork.UserRepository.GetUsernameAsync(User.GetUsername());
        ...
        public async Task<ActionResult> DeletePhoto(int photoId)
        {
            ...
            if(photo.IsMain) return BadRequest("You are not allowed to delete your main photo");
